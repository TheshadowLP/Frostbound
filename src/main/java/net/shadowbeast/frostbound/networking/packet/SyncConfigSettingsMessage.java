...
import net.shadowbeast.frostbound.core.MainSettingConfig;
        ...
        context.enqueueWork(() ->
        {
            ...
            if (context.getDirection().getReceptionSide().isServer())
            {
                ...
                {   ConfigSettings.saveValues();
                    MainSettingConfig.getInstance().save();
                }

                ModMessages.INSTANCE.send(PacketDistributor.ALL.noArg(), new SyncConfigSettingsMessage(EMPTY_UUID));
            }
