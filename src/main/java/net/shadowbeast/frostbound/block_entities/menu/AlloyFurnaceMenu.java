package net.shadowbeast.frostbound.block_entities.menu;
...
import net.shadowbeast.frostbound.block_entities.slot.ResultSlotMod;
import net.shadowbeast.frostbound.registries.ModBlocks;
import org.jetbrains.annotations.NotNull;

import static net.shadowbeast.frostbound.block_entities.entities.AlloyFurnaceBlockEntity.isFuelItem;
...
public class AlloyFurnaceMenu extends AbstractContainerMenu {
    ...
    public @NotNull ItemStack quickMoveStack(@NotNull Player playerIn, int index) {
        ...
        if (index < VANILLA_FIRST_SLOT_INDEX + VANILLA_SLOT_COUNT) {
            ...
            Frostbound.LOGGER.warn("Invalid slotIndex: {}", index);
            return ItemStack.EMPTY;
        }
