...
import net.shadowbeast.frostbound.api.TaskScheduler;
import net.shadowbeast.frostbound.config.ConfigSettings;
import net.shadowbeast.frostbound.networking.ModMessages;
import net.shadowbeast.frostbound.networking.packet.ClientConfigAskMessage;
import net.shadowbeast.frostbound.util.MathHelper;
import net.shadowbeast.frostbound.util.helper.ClientOnlyHelper;
    ...
    public static void eventHandler(ScreenEvent.Init.Post event)
    {
        if (event.getScreen() instanceof OptionsScreen && ConfigSettings.SHOW_CONFIG_BUTTON.get())
        {
            ...
            ImageButton mainButton = new ImageButton(buttonX + xOffset.get(), buttonY + yOffset.get(),
                    24, 24, 40, 40, 24,
                    new ResourceLocation("frostbound:textures/gui/screen/config_gui.png"),
                    button ->
                    {
