...
public abstract class AbstractConfigPage extends Screen
{
    ...
    static ResourceLocation TEXTURE = new ResourceLocation("frostbound:textures/gui/screen/config_gui.png");
    ...
    {   super(Component.translatable("frostbound.config.title"));
                             ...
                             Component... tooltip)
    {
        ...
        if (clientside)
        {   tooltipList.add(Component.translatable("frostbound.config.clientside_warning").withStyle(ChatFormatting.DARK_GRAY));
        }
        // Assign the tooltip
