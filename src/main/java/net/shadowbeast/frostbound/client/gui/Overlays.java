...
{
    public static final ResourceLocation BODY_TEMP_GAUGE = new ResourceLocation(Frostbound.MOD_ID, "textures/gui/overlay/body_temp_gauge.png");
    public static final ResourceLocation BODY_TEMP_GAUGE_HC = new ResourceLocation(Frostbound.MOD_ID, "textures/gui/overlay/body_temp_gauge.png");
