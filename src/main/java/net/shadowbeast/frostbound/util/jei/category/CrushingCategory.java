package net.shadowbeast.frostbound.util.jei.category;
...
public class CrushingCategory implements IRecipeCategory<CrusherRecipe> {
    public static final ResourceLocation UID = new ResourceLocation(Frostbound.MOD_ID, "crushing");
    public static final ResourceLocation TEXTURES = new ResourceLocation(Frostbound.MOD_ID,
    ...
    public Component getTitle() {
        return Component.translatable("jei.frostbound.macerating");
    }
    @Override
