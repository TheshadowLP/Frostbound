package net.shadowbeast.frostbound.entities.projectile;
...
public class MudOverlay {
    ...
    private static final ResourceLocation MUD_OVERLAY_TEXTURE = new ResourceLocation("frostbound:textures/gui/mud_overlay.png");
