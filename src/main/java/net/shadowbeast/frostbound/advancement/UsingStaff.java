package net.shadowbeast.frostbound.advancement;
...
import net.shadowbeast.frostbound.items.staffs.ItemStaff;
...
public class UsingStaff extends SimpleCriterionTrigger<UsingStaff.TriggerInstance> {
    static final ResourceLocation ID = new ResourceLocation(Frostbound.MOD_ID,"using_staff");
