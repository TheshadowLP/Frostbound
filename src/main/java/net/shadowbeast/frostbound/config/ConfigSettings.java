...
import net.shadowbeast.frostbound.core.data.SpawnBiomeData;
import net.shadowbeast.frostbound.temprature.Temperature;
import net.shadowbeast.frostbound.util.DynamicHolder;
...
public class ConfigSettings {
        ...
        public static void load(RegistryAccess registryAccess) {
            ...
            if (registryAccess != null) {
                ...
                Frostbound.LOGGER.warn("Loading Arcane Mysteries config settings without loading registries. This is normal during startup.");
            }
        }
    }
