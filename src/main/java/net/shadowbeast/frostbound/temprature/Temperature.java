package net.shadowbeast.frostbound.temprature;
...
import net.shadowbeast.frostbound.api.GatherDefaultTempModifiersEvent;
import net.shadowbeast.frostbound.api.TempModifierEvent;
import net.shadowbeast.frostbound.api.temperature.TempModifier;
import net.shadowbeast.frostbound.api.util.Placement;
import net.shadowbeast.frostbound.networking.ModMessages;
import net.shadowbeast.frostbound.networking.packet.TempModifiersSyncPacket;
import net.shadowbeast.frostbound.networking.packet.TemperatureSyncPacket;
...
import net.shadowbeast.frostbound.temprature.util.DummyPlayer;
import net.shadowbeast.frostbound.temprature.util.EntityTempManager;
import net.shadowbeast.frostbound.util.InterruptableStreamer;
