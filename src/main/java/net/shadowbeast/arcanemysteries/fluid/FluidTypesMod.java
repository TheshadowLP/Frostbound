...
public class FluidTypesMod {
    ...
    public static final ResourceLocation END_LAVA_STILL_RL = new ResourceLocation(MODID, "block/end_lava_still");
    public static final ResourceLocation END_LAVA_FLOWING_RL = new ResourceLocation(MODID, "block/end_lava_flow");
