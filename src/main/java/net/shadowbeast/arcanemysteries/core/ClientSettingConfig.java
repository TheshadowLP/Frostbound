...
public class ClientSettingConfig {
    ...
    public static void setup()
    {
        ...
        ModLoadingContext.get().registerConfig(ModConfig.Type.CLIENT, SPEC, "arcanemysteries/client.toml");
    }

    public static ClientSettingConfig getInstance()
    {   return new ClientSettingConfig();
    }
