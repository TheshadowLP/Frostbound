...
import net.shadowbeast.arcanemysteries.api.BlockTempRegisterEvent;
import net.shadowbeast.arcanemysteries.api.TempModifierRegisterEvent;
import net.shadowbeast.arcanemysteries.config.BlockTempConfig;
import net.shadowbeast.arcanemysteries.config.ConfigHelper;
import net.shadowbeast.arcanemysteries.core.WorldSettingConfig;
import net.shadowbeast.arcanemysteries.temprature.temp.LavaBlockTemp;
...
public class TempModifierInit
{
    ...
    public static void buildRegistries()
    {
        ...
        {
            ArcaneMysteries.LOGGER.error("Registering TempModifiers failed!");
            throw e;
        }
        ...
        {
            ArcaneMysteries.LOGGER.error("Registering BlockTemps failed!");
            throw e;
        }
    }
    ...
    public static void registerBlockTemps(BlockTempRegisterEvent event)
    {
        ...
        for (List<?> effectBuilder : WorldSettingConfig.getInstance().getBlockTemps())
        {
            ...
            {   ArcaneMysteries.LOGGER.error("Invalid configuration for BlockTemps", e);
                break;
            }
        }
...
//        event.register(new NetherPortalBlockTemp());
        ArcaneMysteries.LOGGER.debug("Registered BlockTemps in {}ms", System.currentTimeMillis() - startMS);
    }
    ...
    {
        long startMS = System.currentTimeMillis();
        event.register(new ResourceLocation(ArcaneMysteries.MOD_ID, "blocks"), BlockTempModifier::new);
        event.register(new ResourceLocation(ArcaneMysteries.MOD_ID, "biomes"), BiomeTempModifier::new);
        ...
        ArcaneMysteries.LOGGER.debug("Registered TempModifiers in {}ms", System.currentTimeMillis() - startMS);
    }
}
