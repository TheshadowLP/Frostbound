...
import net.shadowbeast.arcanemysteries.worldgen.ore.ModOrePlacement;
...
public class ModPlacedFeatures {
    ...
    public static void bootstrap(@NotNull BootstapContext<PlacedFeature> context) {
        ...
        register(context, AQUANIUM_ORE_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.AQUANIUM_ORE_KEY), ModOrePlacement.commonOrePlacement(9, HeightRangePlacement.uniform(VerticalAnchor.absolute(10), VerticalAnchor.absolute(35))));
        ...
        register(context, BONE_ORE_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.BONE_ORE_KEY), ModOrePlacement.commonOrePlacement(15, HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(15))));
        register(context, ENDERIUM_END_ORE_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.ENDERIUM_END_ORE_ORE_KEY), ModOrePlacement.commonOrePlacement(5, HeightRangePlacement.uniform(VerticalAnchor.absolute(50), VerticalAnchor.absolute(70))));
        register(context, FROZEN_GEM_ORE_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.FROZEN_GEM_ORE_KEY), ModOrePlacement.commonOrePlacement(4, HeightRangePlacement.uniform(VerticalAnchor.absolute(15), VerticalAnchor.absolute(35))));
        register(context, LUMINITE_ORE_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.LUMINITE_ORE_KEY), ModOrePlacement.commonOrePlacement(6, HeightRangePlacement.uniform(VerticalAnchor.absolute(-30), VerticalAnchor.absolute(20))));
        register(context, NETHER_FIRERITE_ORE_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.NETHER_FIRERITE_ORE_KEY), ModOrePlacement.commonOrePlacement(6, HeightRangePlacement.uniform(VerticalAnchor.absolute(75), VerticalAnchor.absolute(100))));
        register(context, PLATINUM_ORE_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.PLATINUM_ORE_KEY), ModOrePlacement.commonOrePlacement(3, HeightRangePlacement.uniform(VerticalAnchor.absolute(15), VerticalAnchor.absolute(35))));
        register(context, RUBY_ORE_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.RUBY_ORE_KEY), ModOrePlacement.commonOrePlacement(7, HeightRangePlacement.uniform(VerticalAnchor.absolute(-20), VerticalAnchor.absolute(5))));
        register(context, SAND_AQUANIUM_ORE_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.SAND_AQUANIUM_ORE_KEY), ModOrePlacement.commonOrePlacement(9, HeightRangePlacement.uniform(VerticalAnchor.absolute(45), VerticalAnchor.absolute(60))));
        ...
        register(context, FROZEN_STONE_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.FROZEN_STONE_KEY), ModOrePlacement.commonOrePlacement(128, HeightRangePlacement.uniform(VerticalAnchor.absolute(-10), VerticalAnchor.absolute(90))));
