...
public class ArmorFrozen extends ArmorItem {
    public static final Map<ArmorMaterial, MobEffectInstance> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffectInstance>())
                    .put(ArmorStats.FROZEN, new MobEffectInstance(MobEffects.FIRE_RESISTANCE,
                            200,
                            0, false, false, false)).build();
    private ArmorFrozen(ArmorMaterial pMaterial, Type pType, Properties pProperties) {
    ...
    public static ArmorFrozen getInstance(Type ptype) {
        return new ArmorFrozen(ArmorStats.FROZEN, ptype, new Properties().stacksTo(1));
    }
    @Override
    public void appendHoverText(@NotNull ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, @NotNull TooltipFlag flagIn) {
        tooltip.add(LocalizeUtils.i18n("tooltip.arcanemysteries.fullset"));
        tooltip.add(LocalizeUtils.i18n("tooltip.arcanemysteries.frozen_fullset"));
    }
}
