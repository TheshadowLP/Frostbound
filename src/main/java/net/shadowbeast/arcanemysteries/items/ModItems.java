...
import net.shadowbeast.arcanemysteries.food.ModFood;
import net.shadowbeast.arcanemysteries.items.custom.*;
import net.shadowbeast.arcanemysteries.items.custom.armor.*;


@SuppressWarnings("unused")
public class ModItems {
    public static final DeferredRegister<Item> ITEMS =
            DeferredRegister.create(ForgeRegistries.ITEMS, ArcaneMysteries.MOD_ID);
    ...
    public static final RegistryObject<Item> FROZEN_SHIELD = ITEMS.register("frozen_shield", () -> new ShieldItem(new Item.Properties().durability(910).fireResistant()));
