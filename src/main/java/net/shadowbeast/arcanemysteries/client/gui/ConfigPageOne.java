...
public class ConfigPageOne extends AbstractConfigPage
{
    ...
    {   return Component.translatable("arcanemysteries.config.section.temperature_details");
    }
    ...
    protected void init()
    {
        ...
        */
        ...
        // Celsius
        this.addButton("units", Side.LEFT, () -> Component.translatable("arcanemysteries.config.units.name").append(": ").append(ConfigSettings.CELSIUS.get()
                        ? Component.translatable("arcanemysteries.config.celsius.name")
                        : Component.translatable("arcanemysteries.config.fahrenheit.name")),
                button ->
                {
                ...
                }, false, false, true, Component.translatable("arcanemysteries.config.units.desc"));

        // Max Temperature
        this.addDecimalInput("max_temp", Side.LEFT, Component.translatable("arcanemysteries.config.max_temperature.name"),
                ...
                true, false, false, Component.translatable("arcanemysteries.config.max_temperature.desc"));

        // Min Temperature
        this.addDecimalInput("min_temp", Side.LEFT, Component.translatable("arcanemysteries.config.min_temperature.name"),
                ...
                true, false, false, Component.translatable("arcanemysteries.config.min_temperature.desc"));

        // Temp Damage
        this.addDecimalInput("temp_damage", Side.LEFT, Component.translatable("arcanemysteries.config.temp_damage.name"),
                value -> ConfigSettings.TEMP_DAMAGE.set(value),
                input -> input.setValue(String.valueOf(ConfigSettings.TEMP_DAMAGE.get())),
                true, true, false, Component.translatable("arcanemysteries.config.temp_damage.desc"));

        // Rate Multiplier
        this.addDecimalInput("rate", Side.LEFT, Component.translatable("arcanemysteries.config.temperature_rate.name"),
                value -> ConfigSettings.TEMP_RATE.set(Math.max(0, value)),
                input -> input.setValue(String.valueOf(ConfigSettings.TEMP_RATE.get())),
                true, true, false, Component.translatable("arcanemysteries.config.temperature_rate.desc"));
        ...
        this.addButton("ice_resistance", Side.RIGHT,
                () -> Component.translatable("arcanemysteries.config.ice_resistance.name").append(": ").append(ConfigSettings.ICE_RESISTANCE_ENABLED.get() ? ON : OFF),
                button -> ConfigSettings.ICE_RESISTANCE_ENABLED.set(!ConfigSettings.ICE_RESISTANCE_ENABLED.get()),
                true, true, false, Component.translatable("arcanemysteries.config.ice_resistance.desc"));

        this.addButton("fire_resistance", Side.RIGHT,
                () -> Component.translatable("arcanemysteries.config.fire_resistance.name").append(": ").append(ConfigSettings.FIRE_RESISTANCE_ENABLED.get() ? ON : OFF),
                button -> ConfigSettings.FIRE_RESISTANCE_ENABLED.set(!ConfigSettings.FIRE_RESISTANCE_ENABLED.get()),
                true, true, false, Component.translatable("arcanemysteries.config.fire_resistance.desc"));

        this.addButton("require_thermometer", Side.RIGHT,
                () -> Component.translatable("arcanemysteries.config.require_thermometer.name").append(": ").append(ConfigSettings.REQUIRE_THERMOMETER.get() ? ON : OFF),
                button -> ConfigSettings.REQUIRE_THERMOMETER.set(!ConfigSettings.REQUIRE_THERMOMETER.get()),
                true, true, false, Component.translatable("arcanemysteries.config.require_thermometer.desc"));

        this.addButton("damage_scaling", Side.RIGHT,
                () -> Component.translatable("arcanemysteries.config.damage_scaling.name").append(": ").append(ConfigSettings.DAMAGE_SCALING.get() ? ON : OFF),
                button -> ConfigSettings.DAMAGE_SCALING.set(!ConfigSettings.DAMAGE_SCALING.get()),
                true, true, false, Component.translatable("arcanemysteries.config.damage_scaling.desc"));
    }
}