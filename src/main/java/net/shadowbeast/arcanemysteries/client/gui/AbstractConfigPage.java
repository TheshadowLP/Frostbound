...
public abstract class AbstractConfigPage extends Screen
{
    ...
    static ResourceLocation TEXTURE = new ResourceLocation("arcanemysteries:textures/gui/screen/config_gui.png");
    ...
    {   super(Component.translatable("arcanemysteries.config.title"));
                             ...
                             Component... tooltip)
    {
        ...
        if (clientside)
        {   tooltipList.add(Component.translatable("arcanemysteries.config.clientside_warning").withStyle(ChatFormatting.DARK_GRAY));
        }
        // Assign the tooltip
                                   ...
                                   Component... tooltip)
    {
        ...
        ConfigSliderButton sliderButton = new ConfigSliderButton(buttonX + xOffset, buttonY, buttonWidth, 20, label, 0d)
        {
            ...
            {   onChanged.accept(MathHelper.blend(minVal, maxVal, MathHelper.truncate(this.value, 2), 0, 1), this);
            }
    ...
    public void render(GuiGraphics graphics, int mouseX, int mouseY, float partialTicks)
    {
        ...
        for (Map.Entry<String, List<GuiEventListener>> entry : widgetBatches.entrySet())
        {
            ...
            if (MathHelper.betweenInclusive(mouseX, minX, maxX) && MathHelper.betweenInclusive(mouseY, minY, maxY))
            {
