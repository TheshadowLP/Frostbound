package net.shadowbeast.arcanemysteries.entity.mob.custom;
...
public class DungeonIceEntity extends Monster {
    private final ServerBossEvent bossEvent =
            new ServerBossEvent(Component.translatable("mob.arcanemysteries.dungeonice"), BossEvent.BossBarColor.BLUE, BossEvent.BossBarOverlay.NOTCHED_12);
