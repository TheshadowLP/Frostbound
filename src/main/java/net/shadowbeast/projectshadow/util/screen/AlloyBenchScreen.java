...
public class AlloyBenchScreen extends AbstractContainerScreen<AlloyBenchMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(ProjectShadow.MOD_ID, "textures/gui/fusion_furnace_gui.png");

    public AlloyBenchScreen(AlloyBenchMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
