...
public class ModPlacedFeatures {
    ...
    public static void bootstrap(@NotNull BootstapContext<PlacedFeature> context) {
        ...
        register(context, BONE_ORE_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.BONE_ORE_KEY), ModOrePlacement.commonOrePlacement(18, HeightRangePlacement.uniform(VerticalAnchor.absolute(40), VerticalAnchor.absolute(150))));
        register(context, ENDERIUM_END_ORE_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.ENDERIUM_END_ORE_ORE_KEY), ModOrePlacement.commonOrePlacement(5, HeightRangePlacement.uniform(VerticalAnchor.absolute(70), VerticalAnchor.absolute(90))));
        register(context, FROZEN_GEM_ORE_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.FROZEN_GEM_ORE_KEY), ModOrePlacement.commonOrePlacement(7, HeightRangePlacement.uniform(VerticalAnchor.absolute(60), VerticalAnchor.absolute(120))));
        register(context, LUMINITE_ORE_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.LUMINITE_ORE_KEY), ModOrePlacement.commonOrePlacement(9, HeightRangePlacement.uniform(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(80))));
        ...
        register(context, PLATINUM_ORE_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.PLATINUM_ORE_KEY), ModOrePlacement.commonOrePlacement(12, HeightRangePlacement.uniform(VerticalAnchor.absolute(40), VerticalAnchor.absolute(65))));
