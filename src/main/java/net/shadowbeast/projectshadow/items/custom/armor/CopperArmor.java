...
public class CopperArmor extends ArmorItem {
    public static final Map<ArmorMaterial, MobEffectInstance> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffectInstance>())
                    .put(ArmorStats.COPPER, new MobEffectInstance(MobEffects.DOLPHINS_GRACE/*PLACEHOLDER*/,
                            200,
    ...
    private boolean hasCorrectArmorOn(Player player) {
        ...
        return helmet.getMaterial() == ArmorStats.COPPER && chestplate.getMaterial() == ArmorStats.COPPER
                && leggings.getMaterial() == ArmorStats.COPPER && boots.getMaterial() == ArmorStats.COPPER;
    }
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        if(Screen.hasShiftDown()) {
            pTooltipComponents.add(Component.translatable("tooltip.projectshadow.copper_set.shift"));
        } else {
