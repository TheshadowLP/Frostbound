...
public class TitaniumArmor extends ArmorItem {
    public static final Map<ArmorMaterial, MobEffectInstance> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffectInstance>())
                    .put(ArmorStats.TITANIUM, new MobEffectInstance(MobEffects.DOLPHINS_GRACE/*PLACEHOLDER*/,
                            200,
    ...
    private boolean hasCorrectArmorOn(Player player) {
        ...
        return helmet.getMaterial() == ArmorStats.TITANIUM && chestplate.getMaterial() == ArmorStats.TITANIUM
                && leggings.getMaterial() == ArmorStats.TITANIUM && boots.getMaterial() == ArmorStats.TITANIUM;
    }
