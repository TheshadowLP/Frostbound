...
public class SilverArmor extends ArmorItem {
    public static final Map<ArmorMaterial, MobEffectInstance> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffectInstance>())
                    .put(ArmorStats.SILVER, new MobEffectInstance(MobEffects.DOLPHINS_GRACE/*PLACEHOLDER*/,
                            200,
    ...
    private boolean hasCorrectArmorOn(Player player) {
        ...
        return helmet.getMaterial() == ArmorStats.SILVER && chestplate.getMaterial() == ArmorStats.SILVER
                && leggings.getMaterial() == ArmorStats.SILVER && boots.getMaterial() == ArmorStats.SILVER;
    }
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        if(Screen.hasShiftDown()) {
            pTooltipComponents.add(Component.translatable("tooltip.projectshadow.silver_set.shift"));
        } else {
