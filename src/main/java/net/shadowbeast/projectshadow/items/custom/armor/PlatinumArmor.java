...
public class PlatinumArmor extends ArmorItem {
    public static final Map<ArmorMaterial, MobEffectInstance> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffectInstance>())
                    .put(ArmorStats.PLATINUM, new MobEffectInstance(MobEffects.DOLPHINS_GRACE/*PLACEHOLDER*/,
                            200,
    ...
    private boolean hasCorrectArmorOn(Player player) {
        ...
        return helmet.getMaterial() == ArmorStats.PLATINUM && chestplate.getMaterial() == ArmorStats.PLATINUM
                && leggings.getMaterial() == ArmorStats.PLATINUM && boots.getMaterial() == ArmorStats.PLATINUM;
    }
