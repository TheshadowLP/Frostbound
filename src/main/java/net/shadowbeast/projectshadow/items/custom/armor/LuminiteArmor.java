...
public class LuminiteArmor extends ArmorItem {
    public static final Map<ArmorMaterial, MobEffectInstance> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffectInstance>())
                    .put(ArmorStats.LUMINITE, new MobEffectInstance(MobEffects.DOLPHINS_GRACE/*PLACEHOLDER*/,
                            200,
    ...
    private boolean hasCorrectArmorOn(Player player) {
        ...
        return helmet.getMaterial() == ArmorStats.LUMINITE && chestplate.getMaterial() == ArmorStats.LUMINITE
                && leggings.getMaterial() == ArmorStats.LUMINITE && boots.getMaterial() == ArmorStats.LUMINITE;
    }
