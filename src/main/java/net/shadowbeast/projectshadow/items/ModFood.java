...
public class ModFood {
    ...
    public static final FoodProperties KOHLRABI = (new FoodProperties.Builder()).nutrition(7).saturationMod(0.8F).build(); //TODO
    public static final FoodProperties PEPPER = (new FoodProperties.Builder()).nutrition(7).saturationMod(0.8F).build(); //TODO
}
